...
<div class="days-index card">
    <div class="card-body">
        ...
        foreach ($products as $product) {
            ...
            $str .= $status ? "<input value='" . $buy_value . "' name='buy[" . $product->code . "]' id='" . $product->code . "_" . $diller->id . "' type='number' step='0.1' min='0' class='form-control'/>" : $buy_value;
            $str .= "</td>";
            $str .= "<td style=width:10%;' class='hor-center ver-middle'>";
            $str .= $status ? "<input value='" . $return_value . "' name='return[" . $product->code . "]' type='number' step='0.1' min='0' class='form-control'/>" : $return_value;
            $str .= "</td>";
        ...
        $str .= $status ? "<input type='number'name='given_sum' step='0.1' min='0' class='form-control' value='" . $value_given_sum . "' />" : numberFormat($value_given_sum, 0);
        $str .= "</td>";
        $str .= "<td class='hor-center ver-middle'>".numberFormat($value_loan_sum, 0)."</td>";
        $str .= "</tr>";
        $str .= "</table>";
        echo $str;
