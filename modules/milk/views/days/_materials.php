    ...
    <div class="card-body">
        ...
        if($status){
            foreach ($other_materials as $other_material) {
                ...
                echo $status ? "<input " . $disabled . " onkeyup='calc_sum(this," . $price . ");' name='count[" . $other_material->code . "]' id='count-" . $other_material->code . "' " . $text . " value='" . $value . "' class='form-control' />" : $value;
                echo "</td>";
